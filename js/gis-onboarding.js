...
(function () {
  ...
  var SLIDES = [
    { ic: '💧', t: 'ברוכים הבאים למערכת ה‑GIS של מי הגליל',
      b: 'מערכת ניהול תשתיות המים והביוב — מפה אינטראקטיבית, שכבות, תקלות, מדי מים וכלי רשת. סיור קצר יראה לכם את עיקרי המערכת.' },
    ...
    { ic: '🔍', t: 'חיפוש וסידור שכבות',
      b: 'בראש רשימת השכבות: תיבת "חיפוש שכבה" מסננת את הרשימה לפי שם בזמן אמת, וגרירה מהידית ⋮⋮ שליד כל שכבה מאפשרת לסדר אותה מחדש — שימושי כשיש הרבה שכבות.' },
    { ic: '🔎', t: 'איתור מהיר',
    ...
    { ic: '🗺️', t: 'ייצוא לפי אזור מסומן',
      b: 'באשף הייצוא אפשר לשרטט מלבן על המפה ולקבל מיד סיכום — כמה פריטים מכל שכבה ייכללו — עוד לפני שמורידים בפועל את הקובץ.' },
    { ic: '📋', t: 'טבלת מאפיינים',
      b: 'לחיצה על "מאפיינים ומדים" פותחת טבלה נערכת עם דפדוף לפי עמודים, בחירת כמה שורות יחד לעריכה מרובה, וכפתור "ייצוא CSV" להורדת הנתונים המוצגים.' },
    { ic: '↶', t: 'בטל / בצע שוב',
      b: 'אחרי עריכה על המפה מופיע סרגל קטן עם ↶ בטל ו-↷ בצע שוב — עד 50 פעולות אחורה, לתיקון טעויות בלי דאגה.' },
    { ic: '🛠️', t: 'תקלות בשטח',
