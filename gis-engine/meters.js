...
(function () {
  ...
  GIS.meters = {
    ...
    linkMeterToFeature: async function (meter, feature) {
      ...
      await GIS._requireRole(['admin', 'engineer'], 'link meters');
      var sb = GIS.sb();
    ...
    updateMeter: async function (id, data) {
      ...
      await GIS._requireRole(['admin', 'engineer'], 'edit meters');
    ...
    autoConnect: async function (layerIds, opts) {
      ...
      await GIS._requireRole(['admin', 'engineer'], 'auto-connect meters');
      opts = opts || {};
      var bb = opts.bbox || {};
      var sb = GIS.sb();
    ...
    connectMeter: async function (meterId, pipeId, type) {
      ...
      await GIS._requireRole(['admin', 'engineer'], 'connect meters');
      var sb = GIS.sb();
    ...
    disconnectMeter: async function (meterId) {
      ...
      await GIS._requireRole(['admin', 'engineer'], 'disconnect meters');
      var sb = GIS.sb();
